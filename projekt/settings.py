...
SECRET_KEY = '^sguqlfb#9*b@9r5_lcp=abz#k(sa4!co&%jz73%!9pf+d$er#'
...
INSTALLED_APPS = [
    ...
    'mentorski.apps.MentorskiConfig',
...
LOGIN_REDIRECT_URL = 'mentorski-pocetna'
LOGIN_URL = 'mentorski-prijava'
